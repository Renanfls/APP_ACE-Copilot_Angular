  ...
  template: `
    <footer class="container py-3 mt-44 flex items-center justify-evenly z-50 relative">
      <div class="py-6 flex items-center justify-evenly w-full fixed bottom-0" style="background-color: #141416;">
        <button hlmBtn variant="default" routerLink="/home" class="flex flex-col justify-center items-center rounded-full h-14 focus:opacity-100 opacity-25">
          <img class="h-6 md:h-8" src="assets/home.png" alt="Icone Home">
          <small class="text-sm font-bold mt-3">Home</small>
        </button>
        <button hlmBtn variant="default" routerLink="/as-no-ace" class="flex flex-col justify-center items-center rounded-full h-14 focus:opacity-100 opacity-25">
